...
const navLinks = [
  { name: "L7: Home", tooltip: "Home", to: "hero" },
  { name: "L6: About", tooltip: "About", to: "about" },
  { name: "L5: Skills", tooltip: "Skills", to: "skills" },
  { name: "L4: Projects", tooltip: "Projects", to: "projects" },
  { name: "L3: Experience", tooltip: "Experience", to: "experience" },
  { name: "L2: Contact", tooltip: "Contact", to: "contact" },
];
